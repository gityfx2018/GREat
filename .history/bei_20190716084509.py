...
class Application:
    def __init__(self, master):
        ...
        self.inner_frame_StatusBar.pack(fill='both', expand='yes', padx=5, pady=5)
        self.inner_frame_WordWindow.pack(fill='both', expand='yes', padx=3, pady=3)
        self.inner_frame_OperationWindow.pack(fill='both', expand='yes', padx=3, pady=3)

        # create widgets
        self.label_title = tk.Label(self.inner_frame_StatusBar, text='GREat@背单词')
        self.ShowingWord = tk.Label(self.inner_frame_WordWindow, text='Wait for Load', font=('Arial', 20))
        self.line_between = tk.Canvas(self.inner_frame_WordWindow, height=2, bg='yellow')
        self.ShowingResult = tk.Label(self.inner_frame_WordWindow, text='Wait for Load', font=('Arial', 10))
        ...
        self.button_forget = tk.Button(self.inner_frame_OperationWindow, text='我忘了', width= 13, height=5, command=nextWord_F)
        self.button_remember = tk.Button(self.inner_frame_OperationWindow, text='我记得', width= 13, height=5, command=nextWord_R)
        ...
        self.button1 = tk.Button(self.master,  text = 'Setttings', width = 25, command = self.StartSetttings)
...
class SubApplication:
    def __init__(self, master):
        ...
        self.setting_entry_indicator = tk.Label(self.master, text='输入读取文件地址(请放在当前目录下)')
